...
import { Menu, Calendar as CalendarIcon, MoreVertical, Sun, Moon, Settings, Users, Clock, Palette, Search, MapPin, Star, Bell, UserPlus } from 'lucide-react';
      ...
      <div className="flex items-center">
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-56 bg-white dark:bg-gray-800 p-2 rounded-lg shadow-lg">
            ...
            <DropdownMenuItem onClick={() => openFeature('Vedic Astrology Insights')} className="flex items-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
              <Star className="mr-2 h-4 w-4" />
              <span>Vedic Astrology Insights</span>
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => openFeature('Reminder System')} className="flex items-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
              <Bell className="mr-2 h-4 w-4" />
              <span>Reminder System</span>
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => openFeature('Personalized Recommendations')} className="flex items-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
              <UserPlus className="mr-2 h-4 w-4" />
              <span>Personalized Recommendations</span>
            </DropdownMenuItem>
            <DropdownMenuItem onClick={() => openFeature('Community Forum')} className="flex items-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
              <Users className="mr-2 h-4 w-4" />
